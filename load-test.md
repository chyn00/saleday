...
## Tomcat Thread Pool & Hikari CP 튜닝 최적화 성능 비교

| Percentile    | Default<br>(Tomcat 200 / Hikari 기본) | x30 Threads<br>(Tomcat 300 / Hikari 기본) | x30 + Hikari 300<br>(Tomcat 300 / Hikari 100) |
|---------------|----------------------------------------|--------------------------------------------|-----------------------------------------------|
| **100%**      | 1900ms                                 | 1900ms ✅                                   | **1630ms ✅**                                  |
| **99.99%**    | 1500ms                                 | 1800ms ✅                                   | **1600ms ✅**                                  |
| **99.9%**     | 1300ms                                 | 1400ms ✅                                   | **1200ms ✅**                                  |
| **99%**       | 670ms                                  | 880ms ❌                                   | **500ms ✅**                                   |
| **98%**       | 550ms                                  | 650ms ❌                                   | **310ms ✅**                                   |
| **95%**       | 490ms                                  | 450ms ✅                                   | **280ms ✅**                                   |
| **90%**       | 400ms                                  | 350ms ✅                                   | **230ms ✅**                                   |
| **80%**       | 360ms                                  | 290ms ✅                                   | **210ms ✅**                                   |
| **75%**       | 340ms                                  | 270ms ✅                                   | **210ms ✅**                                   |
| **66%**       | 300ms                                  | 240ms ✅                                   | **190ms ✅**                                   |
| **50% (P50)** | 230ms                                  | 160ms ✅                                   | **140ms ✅**                                   |
| **평균**        | 208ms                                  | 190ms ✅                                   | **154ms ✅**                                   |
| **# 요청수**     | 99,999                                 | 99,989                                     | 100,000                                       |
| **# 실패수**     | 0                                      | 0                                          | 0                                             |
